local L = LibStub("AceLocale-3.0", true):NewLocale("RaidTracker", "ptBR", false)
if not L then return end


-- *** functional strings (must match the game strings exactly) ***

--L.LeftRaid = "([^%s]+) saiu do de raide."
--L.LeftParty = "([^%s]+) saiu do grupo de raide."
--L.LeftParty = "([^%s]+) se ha marchado del grupo de banda."
--L.ReceivesLoot1 = "([^%s]+) recebe o saque: "..RT_ITEMREG.."."
--L.ReceivesLoot2 = "Você recebe o saque: "..RT_ITEMREG.."."
--L.ReceivesLoot3 = "([^%s]+) recebe o saque: "..RT_ITEMREG_MULTI.."."
--L.ReceivesLoot4 = "Você recebe o saque: "..RT_ITEMREG_MULTI.."."
